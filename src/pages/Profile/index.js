...
function Profile() {
    ...
    useEffect(() => {
        if (!sessionStorage.token) {
            ...
            axios.get(config.url.API_URL + "/Profile/Get", {
                ...
                .catch(error => {
                    error.response?.data?.status?.message ? setErrMessage(error.response?.data?.status?.message) : setErrMessage("Gagal mendapatkan profil. Silahkan coba beberapa saat lagi.")
                    setIsProcessing(false)
                })
        }
    }, [history])
    ...
    const onSubmit = ({ currentPassword, password, konfirmasiPassword }, e) => {
        axios.put(config.url.API_URL + "/Profile/ChangePassword", {
                                        ...
                                        <div className="row">
                                            <div className="col-12">
                                                <div className="table-responsive">
                                                    ...
                                                    {data && !isProcessing && <form className="forms-sample" onSubmit={handleSubmit(onSubmit)}>
                                                        <div className="form-group">
                                                            ...
                                                            />
                                                            {!errors.currentPassword && <small className="form-text text-muted">Kata sandi sekurangnya memiliki 6 karakter</small>}
                                                            {errors.currentPassword && (
                                                                <small id="currentPasswordHelp" className="form-text text-danger">
