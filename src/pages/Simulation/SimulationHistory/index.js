...
function SimulationHistory() {
  ...
  const layerListBeforeDiv = useRef(null)
  const layerListAfterDiv = useRef(null)
  ...
  useEffect(() => {
    if (mapBeforeDiv.current && mapAfterDiv.current) {
      ...
      const viewBefore = new SceneView(viewOptions(mapBefore, mapBeforeDiv, false));
      const viewAfter = new SceneView(viewOptions(mapAfter, mapAfterDiv, true));
      ...
      let utamaGroupLayerBefore = new GroupLayer({
        title: "Layer Utama Sebelum",
        layers: [
      ...
      let utamaGroupLayerAfter = new GroupLayer({
        title: "Layer Utama",
        layers: [
          // polaRuangVersioningSesudahLayer,
          persilTanahSesudahLayer,
      ...
      let tambahanGroupLayerBefore = new GroupLayer({
      ...
      let tambahanGroupLayerAfter = new GroupLayer({
        title: "Layer Tambahan",
        layers: [
          frekuensiBanjir2020,
          frekuensiBanjir2019,
      ...
      mapBefore.addMany([tambahanGroupLayerAfter, utamaGroupLayerAfter])
      mapAfter.addMany([tambahanGroupLayerBefore, utamaGroupLayerBefore])

      const layerListBefore = new LayerList({
        view: viewBefore,
        container: layerListBeforeDiv.current
      })
      const layerListAfter = new LayerList({
        view: viewAfter,
        container: layerListAfterDiv.current
      })
      // viewBefore.ui.add(layerListBefore)
      // viewAfter.ui.add(layerListAfter)
    }
  }, []);
    ...
    <div className="container-scroller">
      ...
      <div className="container-fluid page-body-wrapper">
        ...
        <div className="main-panel">
          ...
          {/* <Footer /> */}
          <div className="container-scroller d-md-flex flex-row">
          <div style={{ position: "relative", width: "50%" }} ref={layerListBeforeDiv}></div>
          <div style={{ position: "relative", width: "50%" }} ref={layerListAfterDiv}></div>
          </div>
        </div>
      </div>
    </div>
