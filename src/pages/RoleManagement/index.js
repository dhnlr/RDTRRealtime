    ...
    try {
      Swal.fire({
        ...
        if (action.isConfirmed) {
          axios
            .delete(config.url.API_URL + "/Role/Delete", {
              headers: { Authorization: "Bearer " + sessionStorage.token },
              params: {
                id,
              },
                              ...
                              <Table
                                ...
                                columns={[
                                  ...
                                  },
                                  {
                                    ...
                                    width: "15%",
                                    Cell: (row) =>
                                      row.cell.value.map((permission) => {
                                        return (
                                          <div key={permission}>
                                            <label className="badge badge-pill badge-dark my-1">
                                              {permission}
                                            </label>
                                          </div>
                                        );
                                  ...
                                  },
                                  {
                                    ...
                                    Cell: (row) => (
                                      <div style={{ textAlign: "center" }}>
                                        {row.cell.value ? (
                                          <i className="ti-check text-success text-center"></i>
                                        ) : (
                                          <i className="ti-close text-danger text-center"></i>
                                        )}
                                      </div>
                                    ),
                                  },
