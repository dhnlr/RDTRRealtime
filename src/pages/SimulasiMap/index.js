...
const SimulasiMap = () => {
  ...
  useEffect(() => {
    ...
    if (mapLoaded) {
      ...
      let lModules = loadModules(
      ...
      ).then(([Map, SceneView, FeatureLayer, Legend, watchUtils, Expand, Graphic, Query, Editor, LayerList, Daylight, VectorTileLayer]) => {
        const map = new Map({
          basemap: "topo-vector",
        ...
        const rendererAirBersih = {
          type: "unique-value", // autocasts as new UniqueValueRenderer()
          defaultSymbol: getSymbolAirBersih("#00A884"),
        ...
        map.addMany([airBersihPdamLayer, polaRuangLayer, persilTanahLayer, buildingsAirBersihLayer, buildingsLayer]);
